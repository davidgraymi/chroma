...
import (
	...
	"github.com/davidgraymi/chroma/v2/formatters/html"
	"github.com/davidgraymi/chroma/v2/formatters/svg"
)

var (
	// NoOp formatter.
	NoOp = Register("noop", chroma.FormatterFunc(func(w io.Writer, s *chroma.Style, iterator chroma.Iterator, escape bool) error {
